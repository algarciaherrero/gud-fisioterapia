...
(function initAnimations() {
  ...
  // Forzar visibilidad tras 1.5s como fallback por si el observer falla
  setTimeout(() => {
...
// Base path — cambiar a '' cuando se conecte el dominio gudfisioterapia.com
...
(function initCookieBanner() {
  ...
  // Si ya aceptó o rechazó, no mostramos nada
  try {
  ...
  banner.innerHTML = `
    <div class="cookie-banner__inner">
      <p class="cookie-banner__text">
        Usamos cookies técnicas propias y de terceros (Google Fonts y Google Maps)
        necesarias para el funcionamiento del sitio. No usamos cookies publicitarias.
        <a href="/gud-fisioterapia/cookies/">Más información</a>
      </p>
      <div class="cookie-banner__actions">
        <button class="cookie-btn cookie-btn--reject" id="cookie-reject">Solo necesarias</button>
